class SORN_plot():
    ...
    def spike_plot(self, S_e, S_i, S_et, S_it, N_i_new, start,stop, CV_e, CV_i, filename, save_dir):
        ...
        mpl.rcParams['xtick.major.pad']='18'
        mpl.rcParams['ytick.major.pad']='18'
        mpl.plot(S_et,S_e+N_i_new,'o',color=[0,110/255.0,65/255.0],markersize=5,markeredgecolor=[0,110/255.0,65/255.0], markeredgewidth=0.0, label = "excitatory")
        ...
        print(S_i)        
        mpl.xlim(start,stop)
        mpl.ylim(N_i_new-nshow,N_i_new+nshow)
        mpl.xlabel("time[s]")
